...
docker는 같은 실행환경을 보장해주기 위해서 사용하는 것! 배포할 때나 결과를 재현할 때 환경 그대로를 가져와서 쓸 수 있도록 하는 강력한 도구.

심지어 알맞은 cuda버전을 그대로 가져와서 사용도 가능하다...!
...
**로컬에서 conatiner로 파일 복사**는 local terminal에서 해야 하기 때문이다.
```
